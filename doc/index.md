...
ten of the schema's twelve styles are built, and they reach 49 distinct
...
`test/smoke_v2.py` prices **369 rows of QuantLib's published reference values**
...
<!-- The Sphinx sidebar is built from this; the table above is the same list
     ...
     as a literal code fence and is meant to be ignored. -->
